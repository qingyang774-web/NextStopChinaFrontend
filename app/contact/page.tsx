...
export default function ContactPage() {
  ...
  // FAB (Floating Action Button) state and functions
  const [isFABExpanded, setIsFABExpanded] = useState(false);

  const openWhatsApp = () => {
    window.open('https://wa.me/8637112345678?text=Hi, I am interested in studying abroad with Next Stop Global', '_blank');
  };
  ...
  const openEmail = () => {
    window.open('mailto:info@nextstopglobal.com?subject=Study Abroad Inquiry', '_blank');
  };
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm rounded-full px-6 py-3 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                ...
                <span className="font-semibold text-gray-900">+86 371 1234 5678</span>
              </div>
              <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm rounded-full px-6 py-3 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
