...
export const metadata = {
  title: "Master's Scholarships in China - Graduate Programs",
  description:
    "Explore master's degree scholarships in China. Full and partial scholarships available for graduate programs across 150+ fields of study.",
}

export default function MastersScholarshipsPage() {
  const scholarshipPrograms = [
    {
      title: "Chinese Government Scholarship (CSC) - Master's",
    ...
    },
    {
      ...
      duration: "2-3 years",
      fields: "Engineering, Economics, International Relations",
      requirements: "Bachelor's degree, Relevant experience",
      deadline: "April 30, 2025",
      spots: "100 positions",
    },
    {
      title: "Tsinghua University Graduate Scholarship",
      university: "Tsinghua University",
      coverage: "Full tuition + Research stipend",
      duration: "2-3 years",
      fields: "Engineering, Technology, Management",
      requirements: "Excellent academic performance",
      deadline: "February 15, 2025",
      spots: "40 positions",
    },
    {
      title: "Shanghai Jiao Tong University Scholarship",
    ...
    },
    {
      ...
      duration: "2-3 years",
      fields: "Computer Science, Agriculture, Medicine",
      requirements: "Bachelor's degree, Research interest",
      deadline: "April 15, 2025",
      spots: "80 positions",
    },
    {
      title: "Nanjing University Excellence Scholarship",
      university: "Nanjing University",
      coverage: "70% Tuition + Partial stipend",
      duration: "2-3 years",
      fields: "Liberal Arts, Sciences, Business",
      requirements: "Good grades, Research proposal",
      deadline: "May 1, 2025",
      spots: "50 positions",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-muted/30 py-4">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-foreground">Master's Programs</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground text-pretty leading-relaxed max-w-3xl mx-auto">
              Advance your career with a master's degree from top Chinese universities. Over 150 graduate programs
              available with comprehensive scholarship support and research opportunities.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild className="text-lg px-8">
                <Link href="/apply">
                  Apply for Master's Scholarship <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            <Card className="text-center border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">Full Financial Support</h3>
                <p className="text-muted-foreground">
                  Complete coverage including tuition, accommodation, and monthly research stipends
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">2-3 Year Programs</h3>
                <p className="text-muted-foreground">
                  Intensive graduate programs with thesis research and practical experience
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">150+ Specializations</h3>
                <p className="text-muted-foreground">
                  Advanced programs in technology, business, sciences, and humanities
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-balance">Available Master's Scholarships</h2>
            <p className="text-xl text-muted-foreground text-pretty max-w-2xl mx-auto">
              Comprehensive scholarship opportunities for graduate studies in China
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-balance">Popular Master's Specializations</h2>
            <p className="text-xl text-muted-foreground text-pretty max-w-2xl mx-auto">
              Advanced graduate programs with strong industry connections and research opportunities
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center space-y-4 mb-16">
              ...
              <p className="text-xl text-muted-foreground text-pretty">
                Basic eligibility criteria for master's scholarship applications
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-start space-x-2">
                    ...
                    <span className="text-sm">Bachelor's degree from recognized institution</span>
                  </div>
                  <div className="flex items-start space-x-2">
                    <CheckCircle className="h-4 w-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-sm">Minimum GPA of 3.2 or equivalent</span>
                  </div>
                  <div className="flex items-start space-x-2">
                    <CheckCircle className="h-4 w-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-sm">Official transcripts and degree certificates</span>
                  </div>
                  <div className="flex items-start space-x-2">
                    <CheckCircle className="h-4 w-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-sm">Research proposal or statement of purpose</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-start space-x-2">
                    <CheckCircle className="h-4 w-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-sm">English proficiency (IELTS 6.5+ or TOEFL 90+)</span>
                  </div>
                  <div className="flex items-start space-x-2">
                    <CheckCircle className="h-4 w-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-sm">Two academic recommendation letters</span>
                  </div>
                  <div className="flex items-start space-x-2">
                    <CheckCircle className="h-4 w-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-sm">CV/Resume with relevant experience</span>
                  </div>
                  <div className="flex items-start space-x-2">
                    <CheckCircle className="h-4 w-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-sm">Portfolio or work samples (if applicable)</span>
                  </div>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto space-y-6">
            <h2 className="text-3xl lg:text-4xl font-bold text-balance">
              Advance Your Career with a Master's Degree in China
            </h2>
            <p className="text-xl opacity-90 text-pretty leading-relaxed">
              Join thousands of international students who have transformed their careers through our master's
              scholarship programs. Apply today and secure your future.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Link href="/scholarships/masters" className="block text-primary">
                  Master's Degrees
                </Link>
                <Link
